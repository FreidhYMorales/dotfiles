...
For a practical map of commented-out theme color tokens and how to visualize each UI element locally on macOS, see [docs/commented-scopes.md](docs/commented-scopes.md).
